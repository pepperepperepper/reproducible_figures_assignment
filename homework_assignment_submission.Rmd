...
My partner could use the summary() function only once in their code. Currently, they use the summary() function twice when creating the linear model and again in the results section. As this output takes up a fair amount of space, it might be useful to only run the function in the results. However, in the knitted .html file, my partner does hide the first output but it might not be necessary to have the function in the first place while running it.
